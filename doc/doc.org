...
***** NEXT Make things compile with the new repo structure
***** NEXT [1/3] write the SCION packet parser
...
******* TODO test it
***** TODO MAYBE Getting started 2 [0/1]
...
*** TODO what to do about packets which aren't SCION?
*** TODO LICENSE?
