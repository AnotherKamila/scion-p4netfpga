...
*** TODO Building a high-speed SCION router in hardware
    ...
    possible), and thereby create a "library" for implementing line-rate SCION
    for a variety of targets and use-cases.
