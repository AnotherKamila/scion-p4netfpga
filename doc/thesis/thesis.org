...
***** DONE Changes to the code have highly unpredictable effects
      ...
      As an example, the packet corruption described in [[*Unexplained packet
      corruption when handling parser errors]] was not visible in the simulation
      at all, and it took about a week to track down the cause.
...
***** TODO Control plane API issues
      had to write my own reg_write and stuff
