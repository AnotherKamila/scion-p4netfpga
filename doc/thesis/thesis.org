...
*** DONE [3/3] Introduction to designing for FPGAs
...
***** DONE Overview of the design process
...
***** DONE The hard problem in FPGA design: Meeting timing
      CLOSED: [2019-08-31 Sat 21:16]
...
* [1/1] Design overview
  ...
  and a thin wrapper that reads the SCION config files and writes the
...
*** DONE [7/7] Working around compiler and toolchain bugs
...
***** DONE Very high tooling complexity
      ...
      building workflow]], there were several other issues. We sumarise them here.
...
***** DONE Packet generation helper script utterly broken
      ...
      documentation.
***** DONE Changes to the code have highly unpredictable effects
...
***** DONE Silent failures, no way to detect errors early
      CLOSED: [2019-08-30 Fri 17:50]
      ...
      extern contains an error, this will not be obvious.
      ...
      fail at all, use stale intermediate data instead of the erroneus parts,
...
***** DONE High difficulty of writing cross-platform code
...
***** Timestamp validation
      ...
      short time.
*** DONE Area and timing constraints
...
* [3/3] Analysis
*** DONE Discussion of the measurements
...
***** Packet loss (or lack thereof)
      ...
      queueing packets on the input or on the output, either due to processing
...
*** DONE Guidelines for high-speed packet processing
...
***** Types of problems suitable for P4
      ...
      state shared among multiple packet is limited to a few primitives, such as
      register arrays.
...
******* DONE Reducing data dependencies
        CLOSED: [2019-08-31 Sat 18:44]
...
******* DONE Externs can be expensive
        ...
        the available 5 ns.
*** DONE Implications for the SCION protocol
...
***** DONE [4/4] What could be improved
      CLOSED: [2019-08-30 Fri 16:20]
******* DONE Define maximum sizes
...
******* DONE Avoid implicit lengths
        ...
        alongside the type.
******* DONE Consider re-thinking MAC chaning for peering paths
...
[fn:17] For example, the latest performace report of DPDK by Intel
