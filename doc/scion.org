...
********* NEXT Write P4 code (with blanks) that does it                 :aes:
...
********* DONE find 3rd party AES module                                :aes:
          CLOSED: [2019-03-17 Sun 18:48] SCHEDULED: <2019-03-28 Thu>
          make it easily replaceable with commercial solutions
          ==> don't worry about side channels (not my problem) :D
...
********* DONE Integrate actual AES                                     :aes:
          CLOSED: [2019-03-25 Mon 13:26] SCHEDULED: <2019-03-28 Thu>
...
*** NEXT progress report <2019-03-20 Wed>
 - Minor milestone: completed and tested parsing and forwarding for the base case
